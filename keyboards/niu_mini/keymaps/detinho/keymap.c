...
void the_w_2_www (qk_tap_dance_state_t *state, void *user_data) {
  if (state->count == 2) {
    SEND_STRING("2");
    reset_tap_dance(state);
...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_W_2] = ACTION_TAP_DANCE_FN(the_w_2_www),
...
[_QWERTY] = LAYOUT_ortho_4x12(
  TAB_NP,   TD(TD_Q_1),    TD(TD_W_2),    TD(TD_E_3),    KC_R,  KC_T,          KC_Y,     KC_U,          KC_I,         KC_O,    KC_P,    KC_BSPC,
  ESC_TX,   KC_A,    KC_S,    KC_D,    KC_F,  KC_G,          KC_H,     TD(TD_J_UNDS), TD(TD_K_EQL), KC_L,    KC_SCLN, TD(TD_QT_DQT),
  KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,  TD(TD_B_TMUX), KC_N,     KC_M,          KC_COMM,      KC_DOT,  KC_SLSH, KC_RSFT,
  CTL_CAPS, KC_LEAD, KC_LALT, KC_LGUI, LOWER, SPC_TX,        KC_ENTER, RAISE,         KC_LEFT,      KC_DOWN, KC_UP,   LCTL_T(KC_RGHT)
),
...
[_ADJUST] = LAYOUT_ortho_4x12(
  _______, RESET,   _______, _______, _______, _______, _______, _______, _______, _______, _______, DF(_NUMPAD),
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  BL_TOGG, _______, _______, _______, _______, _______, _______, _______, _______, RGB_RMOD, RGB_MOD, RGB_TOG
),
...
[_NUMPAD] = LAYOUT_ortho_4x12(
  ...
  DF(_QWERTY), _______, _______, _______, _______, KC_PENT, KC_KP_0, KC_KP_0, KC_PDOT, _______, _______, _______
)
...
void matrix_scan_user(void) {
  ...
  LEADER_DICTIONARY() {
    ...
    SEQ_THREE_KEYS(KC_Z, KC_Z, KC_Z) {
      SEND_STRING("Bom dia Zuza, beleza e vc?");
    }

    SEQ_THREE_KEYS(KC_T, KC_T, KC_T) {
      SEND_STRING("Bom dia Thais, beleza e vc?");
    }

    SEQ_THREE_KEYS(KC_L, KC_L, KC_L) {
      SEND_STRING("Bom dia Leandro, beleza e vc?");
    }
